...
namespace CudafyExamples
{
    ...
    public class CudafyClassExamples
    {
        public static void Execute()
        {
            ...
            CudafyModule km = CudafyTranslator.Cudafy(Program.testArchitecture, new Type[] { typeof(BaseClass), typeof(MemberClass), typeof(DerivedClass), typeof(ArrayView), typeof(CudafyClassExamples) });
